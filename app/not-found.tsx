        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="relative inline-flex">
              <div className="absolute left-full -mt-4 fill-slate-300 dark:fill-slate-700 hidden lg:block" aria-hidden="true">
              ...
              <h1 className="h1 font-playfair-display text-slate-800 dark:text-slate-100 mb-4">Oops!</h1>
            </div>
            <p className="text-xl text-slate-500 dark:text-slate-400">We couldn't find the page you're looking for.</p>
            <div className="mt-8">
