    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white dark:bg-gray-700 rounded-lg shadow-lg">
              ...
              <h4 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Fast-Track Your Success</h4>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-700 rounded-lg shadow-lg">
              ...
              <h4 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Boost Close Rates & Earnings</h4>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-700 rounded-lg shadow-lg">
              ...
              <h4 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Build Lasting Confidence</h4>
      ...
      <section className="bg-blue-600 dark:bg-blue-700 py-12 md:py-20">
        <div className="max-w-3xl mx-auto text-center px-4 sm:px-6">
          <h2 className="text-3xl font-bold text-white mb-4">Experience the Transformation Yourself</h2>
